...
#put the video or capture by your web cam
...
##            print str(i.getX()), ',', str(i.getY())
    ...
    cv2.putText(frame, str_up, (10, 40), font, 0.5, (0, 255, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, str_up, (10, 40), font, 0.5, (0, 0, 255), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, str_down, (10, 90), font, 0.5, (255, 255, 0), 1, cv2.FONT_HERSHEY_PLAIN)
    cv2.putText(frame, str_down, (10, 90), font, 0.5, (255, 0, 0), 1, cv2.FONT_HERSHEY_PLAIN)

    out.write(frame)
    cv2.imshow('PDM', frame)
